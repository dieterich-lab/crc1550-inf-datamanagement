...
The cubi-tk is a command line tool that allows to interact with SODAR server. The command `cubi-tk sodar ingest-fasq` because of configuration error. Use \<cubi-tk sodar ingest\>.
