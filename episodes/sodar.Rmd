...
5.  Call SODAR validation to check whether the data upload was successful. 

6. Modify or fix any entries.

# Standard Operating Procedure for Data and Metadata Registry with SODAR Service

The SOP is avaiable here: https://cloud.crc1550.com/index.php/s/nW6CGRiDHPtP5KP
...
:::::: keypoints
 - SODAR is a easy-to-use and open source solution for data management.
 - It allows us to adhere to the FAIR framework. 
::::::
